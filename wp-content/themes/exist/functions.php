...
/**
 * exist functions and definitions
 *
...
if (!function_exists('exist_setup')) :
	...
	function exist_setup()
	{
		 ...
		 * If you're building a theme based on exist, use a find and replace
		 * to change 'exist' to the name of your theme in all the template files.
		 */
