...
class NOA_Walker extends Walker_Nav_Menu
{
    ...
    function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        $scroll_to = get_field('scroll_to', $item);
        ...
        $output .= '<a href="' . $permalink . $hash . '" data-scroll="' . get_field('scroll_to', $item) . '">';
...
class Bootstrap_NavWalker extends Walker_Nav_Menu {
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $item_output .= '<a' . $attributes . ' data-scroll="' . get_field('scroll_to', $item) . '">';
